...
public class EmailService {
    ...
    public Page<EmailResponse> findAll(Pageable pagable) {
        return emailRepository.findAll(pagable)
                .map(emailEntityMapper::mapToResponse);
    }

    public EmailResponse findById(long id) throws NoSuchEmailException {
    ...
    @Transactional
    public EmailResponse create(EmailCreationRequest request) {
        return emailEntityMapper.mapToResponse(
    ...
    @Transactional
    public Collection<EmailResponse> createBulk(EmailBulkCreationRequest request) {
    ...
    @Transactional
    public EmailResponse update(long existingEmailId, EmailUpdateRequest request) throws NoSuchEmailException, EmailUpdateFailedException {
    ...
    public void delete(EmailBulkDeletionRequest request) {
